...
export type tProfession = {
  ...
  diploma?: tDiploma | string | null;
  experience?: tExperience | string | null;
  availability?: tAvailability | string | null;
};
...
export type tContract = {
  ...
  remuneration: tRenumeration | string | null;
};
...
export type tPartnerPersonalInfos = {
  ...
  familySituation?: tSituation | string | null;
...
export type filterPartner = {
  city?: string | null;
  jobs?: string | null;
  speciality?: string | null;
  availability?: tAvailability | string | null;
  typeOfContract?: tTypeOfContract | string | null;
  isActive?: boolean | null;
  searchTerm?: React.ChangeEventHandler<HTMLInputElement> | null | string;
  limit?: number | null;
  page?: number | null;
};
...
export type tPartnerStore = {
  ...
  filterPartner: filterPartner | null;
